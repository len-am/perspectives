 ...
 * Copyright (c) 2009-2011 by Perspective, Inc. All Rights Reserved.
...
//@interface PerspectiveObject : NSObject
//@end

@interface PerspectiveObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PerspectiveObject class]])
		{
			for (NSString *key in [[(PerspectiveObject*)o modules] allKeys])
			{
