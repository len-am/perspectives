...
/**
 Base class for all Perspective views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Perspective view hierarchy (such as wrapped iOS UIViews) was touched.
