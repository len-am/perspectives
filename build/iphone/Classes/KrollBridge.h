...
@interface PerspectiveObject : KrollCoverageObject {
#else
@interface PerspectiveObject : KrollObject {
#endif
@private
...
extern NSString * Perspective$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	PerspectiveObject *_perspective;
    KrollObject* console;
	BOOL shutdown;
