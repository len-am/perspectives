...
// in simulator we redefine to format for Perspective Developer console
...
{\
	NSString * exceptionName = [@"org.perspective." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.perspective";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIPerspectiveNativeItemNone = -1, 
	UIPerspectiveNativeItemSpinner = -2,
	UIPerspectiveNativeItemProgressBar = -3,
	
	UIPerspectiveNativeItemSlider = -4,
	UIPerspectiveNativeItemSwitch = -5,
	UIPerspectiveNativeItemMultiButton = -6,
	UIPerspectiveNativeItemSegmented = -7,
	
	UIPerspectiveNativeItemTextView = -8,
	UIPerspectiveNativeItemTextField = -9,
	UIPerspectiveNativeItemSearchBar = -10,
	
	UIPerspectiveNativeItemPicker = -11,
	UIPerspectiveNativeItemDatePicker = -12,
	
	UIPerspectiveNativeItemInfoLight = -13,
	UIPerspectiveNativeItemInfoDark = -14,
	
	UIPerspectiveNativeItemDisclosure = -15,
	
	UIPerspectiveNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Perspective instances of
